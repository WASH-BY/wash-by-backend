...
carWashRouter
  ...
  .put(auth, carWashController.updateCarWashByWasher);
carWashRouter
  .route("/endCarWash/:id")
  .put(auth, carWashController.upDateCarWashingOnCompletion);
carWashRouter
...
carWashRouter.route("/createCarWashesManually").get(auth, carWashController.createCarWashManually);
